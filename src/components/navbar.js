  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center flex-wrap">
      <a href="/" className="flex items-center mb-2 sm:mb-0">
        ...
        <span className="text-xl font-bold text-gray-800">MOHAMMAD AMIR</span>
      </a>

      <div className="flex items-center flex-wrap w-full sm:w-auto sm:flex-nowrap">
        <div className="relative w-full sm:w-auto sm:mr-4 mb-2 sm:mb-0">
          <input
            type="text"
            placeholder="Search for course"
            className="w-full sm:w-64 px-5 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
          />
          <SearchIcon className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-600" />
        </div>

        <a href="/become-instructor" className="ml-4 text-gray-600 hover:text-gray-800 mb-2 sm:mb-0">
          Download CV
        </a>
        ...
        <a href="/login" className="ml-4 px-3 py-2 rounded-lg border border-gray-300 text-gray-600 hover:text-gray-800 mb-2 sm:mb-0">
          Login
        </a>
